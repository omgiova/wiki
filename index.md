...
- [[wiki/projects/automacao-trello-libertas.md|Automação Trello — Libertas]] — fluxo único n8n sobre o board Libertas - Assist Virtual Financeiro; avisa Thairine e Luciana no WhatsApp (adição a card, menção, resposta, etiqueta APROVADO), janela 9h-18h com fila fora do horário; ativo desde 2026-09-22
...
- [[wiki/tools/llm-usage.md|llm-usage]] — CLI em /root/scripts/llm-usage que reporta consumo de LLMs (todos os providers, discriminados por `billing_provider`): nº de requisições e tokens por dia × provider × modelo em janelas de 15m a 1w ou desde uma data + % do plano OpenCode Go via API
...
- [[wiki/tools/criar-artigo-seo-libertas-skill.md|Skill criar-artigo-seo-libertas]] — registro de existência da skill do Claude Code para produzir artigos de SEO da Libertas; regras vivem no SKILL.md
...
- [[wiki/history/2026-09-21-vps-travou-swap.md|VPS travou + swap]] — VPS congelou (load ~44), Docker Swarm reiniciou todos os serviços; finflow dev e promptgolf desligados; swap de 2GB criado
